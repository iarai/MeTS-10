...
@pytest.mark.parametrize(
    ...
    [
        ...
        [8.0, 50.0, 8.494, 50.0, 0, 435, True],
        [8.0, 50, 8.494, 50.435, 0, 0, True],
        [8.0, 50.0, 8.0, 50.0, 494, 435, True],
        [8.0, 50.0, 8.0, 50.435, 494, 0, True],
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        [8.0, 50.0, False, 0, 435, [(8.435, 50.495), (8.435, 50.494), (8.436, 50.494), (8.436, 50.495), (8.435, 50.495)]],
        ...
        [8.0, 50.0, True, 0, 0, [(8.494, 50.436), (8.494, 50.435), (8.495, 50.435), (8.495, 50.436), (8.494, 50.436)]],
        [8.0, 50.0, True, 0, 435, [(8.494, 50.001), (8.494, 50.0), (8.495, 50.0), (8.495, 50.001), (8.494, 50.001)]],
        [8.0, 50.0, True, 494, 435, [(8.0, 50.001), (8.0, 50.0), (8.001, 50.0), (8.001, 50.001), (8.0, 50.001)]],
        [8.0, 50.0, True, 494, 0, [(8.0, 50.436), (8.0, 50.435), (8.001, 50.435), (8.001, 50.436), (8.0, 50.436)]],
    ],
)
...
def test_get_intersecting_grid_cells():
    ...
    cells = get_intersecting_grid_cells(line, lon_min, lat_min, rotate=True)
    expected_cells_forward = [(484, 415, 0, 0.0), (481, 413, 0, 0.0), (482, 414, 0, 0.5), (483, 414, 0, 0.5), (484, 414, 0, 0.0)]
    assert_intersecting_cells_equal(cells, expected_cells_forward)
    ...
    cells = get_intersecting_grid_cells(line, lon_min, lat_min, rotate=True)
    expected_cells_forward = [(483, 414, 1, 1.0), (484, 414, 0, 1.0), (484, 414, 1, 1.0), (483, 414, 0, 1.0)]
    assert_intersecting_cells_equal(cells, expected_cells_forward)
