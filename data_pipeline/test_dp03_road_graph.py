...
def test_hash_deterministic():
    # https://bugs.python.org/issue27925
    h = gkey_hash(b"\x01\x02\x00\x00\x00\x02\x00\x00\x00R\xaf\x00KS\xa9\xc2\xbfq\xe3\x16\xf3s\xc3I@\xf1B\xdf\x82\x11\xa0\xc2\xbf\xee\x8e1\x1ct\xc3I@")
    assert h <= sys.maxsize
    assert h == 6311286378999487849
